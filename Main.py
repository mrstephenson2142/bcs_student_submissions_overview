...
# 
# You might be asking yourself, "what's up with all these functions that aren't really used like functions". 
# I was originally going a different direction and didn't see a need to change them back. 
